//color picker js from
//https://github.com/DavidDurman/FlexiColorPicker/blob/master/colorpicker.js
(function(window, document, undefined) {
  var type = (window.SVGAngle ||
      document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML");
  var picker = 15;
  var slide = 15;
  var hueOffset = 15;
  ...
  ColorPicker.hsv2rgb = function(hsv) {
    ...
    Reflect.defineProperty(rgbHex, 'hex');
    return rgbHex;
  };
